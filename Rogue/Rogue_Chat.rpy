        ...
        "Show me the plug." if R_Plugged:
                    ...
                    if ApprovalCheck("Rogue", 1450, TabM = 3) or ApprovalCheck("Rogue", 800, "O") or "exhibitionist" in R_Traits: # 145, 160, 175, Taboo -160(355)
                        ...
                        if R_Legs == "skirt" or R_Legs == "SR7 skirtshort" or R_Legs == "skirtshort" or R_Legs == "cheerleader skirt" or R_Legs == "cheerleader skirtshort" or R_Over == "blue dress" or R_Over == "red dress":
                            ...
                            $ R_Hose = Temp_R_Hose
                            pause
                        elif R_Panties and R_Panties != "lace panties" and R_Panties != "black panties" and R_Panties != "swimsuit1" and R_Panties != "bodysuit" and R_Panties != "swimsuit2":
                            $ R_PantiesDown = 1
                            "And pulls down her [R_Panties]"
                            ch_r "There, you happy?"
...
#            "Say you love her":
        ...
        "Flip her skirt up" if (R_Legs == "skirt" or R_Legs == "skirtshort" or R_Legs == "SR7 skirtshort" or R_Legs == "cheerleader skirt" or R_Legs == "cheerleader skirtshort" or R_Over == "blue dress" or R_Over == "red dress") and not R_Upskirt:   #Flip her skirt           
                    ...
                    #End Flip her Skirt
        "Pull her panties down" if (R_Legs == "skirt" or R_Legs == "SR7 skirtshort" or R_Legs == "skirtshort" or R_Legs == "cheerleader skirt" or R_Legs == "cheerleader skirtshort" or R_Over == "blue dress" or R_Over == "red dress" or not R_Legs) and R_Panties and R_Panties != "swimsuit1" and not R_BodySuit and R_Panties != "swimsuit2" and not R_PantiesDown and not R_Hose:            
        ...
        "Ask for her panties" if R_Panties != "swimsuit1" and R_Panties != "bodysuit" and R_Panties != "swimsuit2":
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Rogue_Clothes_Outfits:                                                                                 # Outfits
        ...
        "That classic uniform looks really nice on you.":                           #Pink  
        ...
        "That damaged classic uniform looks really nice on you.":                           #Pink  
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Rogue_Clothes_Over:                                                                                            # Overshirts    
        ...
        "How about you classic jacket?" if R_Over != "classic jacket":
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<                        
    ...
    menu Rogue_Clothes_Legs:                                                                                                    # Leggings   
        ...
        "Your ass looks tight in those leather pants." if R_Legs != "leather pants":
                        $ R_Legs = "leather pants"
                        $ R_Hose = 0
                
        "The tights would look good with that." if R_Hose != 'tights' and PantsNum("Rogue") != 10:     
                        $ R_Hose = "tights"                   
        "Your ripped tights would look good with that." if R_Hose != 'ripped tights' and "ripped tights" in R_Inventory and PantsNum("Rogue") != 10:     
        ...
        "What about wearing your shorts?":
                        menu:
                          ...
                          "The green one suits you well." if R_Legs != "shorts":
                                ch_r "Alright."
                                $ R_Legs = "shorts"
                          "The blue one looks nice on you." if R_Legs != "blue shorts":
                                ch_r "Alright."
                                $ R_Legs = "blue shorts"
                          "The red one looks hot." if R_Legs != "red shorts":
                                ch_r "Alright."
                                $ R_Legs = "red shorts"
                                
                                            
        "Why don't you lose the shorts?" if R_Legs == "shorts" or R_Legs == "red shorts" or R_Legs == "blue shorts":
                        call RogueFace("sexy", 1) from _call_RogueFace_742
                        if R_BodySuit or HoseNum("Rogue") >= 10:
                             ch_r "Sure."
                        elif not R_Panties and R_SeenPussy and ApprovalCheck("Rogue", 500, TabM=4): # You've seen her pussy
                        ...
                        elif not R_Panties:                       #she's not wearing anything under them
    ...
    menu Rogue_Clothes_Under: 
            ...
            menu Rogue_Clothes_Under_Top:
                ...
                "How about you lose the [R_Chest]?" if R_Chest and "swimsuit" not in R_Chest:
                        ...
                        if R_BodySuit:
                            ...
                            ch_r "I guess I don't really mind if you see them. . ."
                        elif R_Over == "jacket" and ApprovalCheck("Rogue", 500, TabM=2):
                ...
                "Try on that green top." if R_Chest != "green top":
                                call Rogue_Swimsuit_Change_Top
                                $ R_Chest = "green top" 
                                jump Rogue_Clothes_Under_Top
        ...
        "Hoses and stockings":
            menu Rogue_Clothes_Under_Hoses:
                ...
                "The thigh-high hose would look good with that." if R_Hose != "stockings" and PantsNum("Rogue") != 10:     
                                $ R_Hose = "stockings"  
                                jump Rogue_Clothes_Under_Hoses
                "The pantyhose would look good with that." if R_Hose != "pantyhose" and PantsNum("Rogue") != 10:     
                                $ R_Hose = "pantyhose" 
                                jump Rogue_Clothes_Under_Hoses
                "The stockings would look good with that." if R_Hose != "stockings and garterbelt" and "stockings and garterbelt" in R_Inventory and PantsNum("Rogue") != 10:     
                                $ R_Hose = "stockings and garterbelt"  
                                jump Rogue_Clothes_Under_Hoses
                "Your ripped pantyhose would look good with that." if R_Hose != "ripped pantyhose" and "ripped pantyhose" in R_Inventory and PantsNum("Rogue") != 10:     
                                $ R_Hose = "ripped pantyhose"                
                                jump Rogue_Clothes_Under_Hoses
                "You could use that fishnet" if R_Hose != "fishnet" and PantsNum("Rogue") != 10:
                                $ R_Hose = "fishnet" 
                                jump Rogue_Clothes_Under_Hoses

                "You could use that SR7 hose" if R_Hose != "SR7 hose" and PantsNum("Rogue") != 10:
                                $ R_Hose = "SR7 hose" 
                                jump Rogue_Clothes_Under_Hoses
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Rogue_Clothes_BodySuits: 
        "BodySuits":
            menu Rogue_Clothes_BodySuits_Body:
                ...
                "You could lose that bodysuit. . ." if R_BodySuit:
                                ...
                                if (not R_Legs or (R_Legs == "skirtshort" or R_Legs == "SR7 skirtshort" or R_Legs == "cheerleader skirtshort")) and not R_Panties:
                                    ...
                                    $ R_Inbt = Statupdate("Rogue", "Inbt", R_Inbt, 50, 2)  
                                jump Rogue_Clothes_BodySuits_Body
...
label Rogue_OutfitShame(Custom = 3, Check = 0, Count = 0, Tempshame = 50, Agree = 1):                                                                             #sets custom outfit    
            ...
            if (R_Legs or R_Over == "red dress" or R_Over == "blue dress" or R_BodySuit == "classic uniform") and R_Panties: #If wearing both legs and panties   
                        $ Count = 30        
                        ...
                        elif R_Legs == "shorts":             #If wearing shorts
                            $ Count = 25
                        elif R_Legs == "red shorts":             #If wearing shorts
                            $ Count = 25
                        elif R_Legs == "blue shorts":             #If wearing shorts
                            $ Count = 25  
                        elif R_Panties == "green panties":      #If wearing only green panties
                            $ Count = 10
            ...
            if not Check:
                ...
                pass
                        ...
                        elif (R_Legs == "shorts" or R_Legs == "red shorts" or R_Legs == "blue shorts"):
            ...
            if Check:
                    ...
                    if Custom == 5:
                        ...
                        $ R_Custom2[4] = R_Neck
                        $ R_Custom2[5] = R_Chest 
                        $ R_Custom2[13] = R_BodySuit
                        $ R_Custom2[14] = R_Headband
                        $ R_Custom2[15] = R_Accessory
                        $ R_Custom2[14] = R_Headband
                        $ R_Custom2[15] = R_Accessory
                        ...
                        $ R_Custom3[4] = R_Neck
                        $ R_Custom3[5] = R_Chest 
                        $ R_Custom3[13] = R_BodySuit
                        $ R_Custom3[14] = R_Headband
                        $ R_Custom3[15] = R_Accessory
                        ...
                        $ R_Sleepwear[13] = R_BodySuit
                        $ R_Sleepwear[14] = R_Headband
                        $ R_Sleepwear[15] = R_Accessory
                        ...
                        $ R_Custom5[4] = R_Neck
                        $ R_Custom5[5] = R_Chest 
                        $ R_Custom5[13] = R_BodySuit
                        $ R_Custom5[14] = R_Headband
                        $ R_Custom5[15] = R_Accessory
                        ...
                        $ R_Custom6[4] = R_Neck
                        $ R_Custom6[5] = R_Chest 
                        $ R_Custom6[13] = R_BodySuit
                        $ R_Custom6[14] = R_Headband
                        $ R_Custom6[15] = R_Accessory
                        ...
                        $ R_Custom7[4] = R_Neck
                        $ R_Custom7[5] = R_Chest 
                        $ R_Custom7[13] = R_BodySuit
                        $ R_Custom7[14] = R_Headband
                        $ R_Custom7[15] = R_Accessory
                        ...
                        $ R_Custom4[4] = R_Neck
                        $ R_Custom4[5] = R_Chest 
                        $ R_Custom4[13] = R_BodySuit
                        $ R_Custom4[14] = R_Headband
                        $ R_Custom4[15] = R_Accessory
...
label Rogue_Swimsuit_Change_Top:
    if R_Chest != "swimsuit1" and R_Chest != "bodysuit" and R_Chest != "swimsuit2":
        return
...
label Rogue_Swimsuit_Change_Bottom:
    if R_Panties != "swimsuit1" and R_Panties != "bodysuit" and R_Panties != "swimsuit2":
        return
